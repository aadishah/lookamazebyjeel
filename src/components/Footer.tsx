  ...
  return (
    ...
    <footer className="bg-foreground text-background py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 pt-6 border-t border-background/20 text-center text-background/50 text-xs">
        ...
        <p>© {new Date().getFullYear()} Lookamaze by Jeel Shah. All rights reserved.</p>

        <p className="mt-1">Made by <a href="https://www.instagram.com/thecyclewala" target="_blank" rel="noopener noreferrer" className="hover:text-background transition-colors underline">Aaditya Shah</a></p>
